    ...
    ChartJs.prototype.init = function() {
            ...
            datasets: [
                {
                    ...
                    pointBorderColor: "#ec536c",
                    pointBackgroundColor: "#fff",
                    pointBorderWidth: 1,
                    pointHoverRadius: 5,
                    pointHoverBackgroundColor: "#ec536c",
        ...
        var barChart = {
            ...
            datasets: [
                {
                    label: "Sales Analytics",
                    backgroundColor: "#fab249",
                    borderColor: "#fab249",
                    borderWidth: 1,
                    hoverBackgroundColor: "#fab249",
                    hoverBorderColor: "#fab249",
        ...
        var radarChart = {
            ...
            datasets: [
                ...
                },
                {
                    ...
                    backgroundColor: "rgba(236, 83, 108, 0.2)",
                    borderColor: "#ec536c",
                    pointBackgroundColor: "#ec536c",
                    pointBorderColor: "#fff",
                    pointHoverBackgroundColor: "#fff",
                    pointHoverBorderColor: "#ec536c",
