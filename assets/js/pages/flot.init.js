  ...
  FlotChart.prototype.createDonutGraph = function(selector, labels, datas, colors) {
    ...
    tooltipOpts : {
      ...
      FlotChart.prototype.init = function() {
        ...
        var pcolors = ['#f0f1f4', '#fab249', '#ec536c'];
        ...
        var datas = [20,30, 15];
        var colors = ['#ec536c','#fab249', "#ebeff2"];
        this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);


          //real time data representation
          var plot = this.createRealTimeGraph('#flotRealTime', this.randomData() , ['#fab249']);
          plot.draw();
          var $this = this;
          function updatePlot() {
        ...
        var donutcolors = ['#f0f1f4', '#ec536c', '#fab249'];
