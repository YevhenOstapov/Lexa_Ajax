...
!function ($) {
    ...
    var MorrisCharts = function () {
        ...
        MorrisCharts.prototype.init = function () {
            ...
            this.createLineChart('morris-line-example', $data, 'y', ['a', 'b', 'c'], ['Activated', 'Pending', 'Deactivated'], ['#ccc', '#ec536c', '#fab249']);
            ...
            this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b'], ['Series A', 'Series B'], ['#ec536c','#fab249']);
            ...
            this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B', 'Series C'], ['#ccc', '#fab249', '#ec536c']);
            ...
            this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a', 'b'], ['Series A', 'Series B'], ['#ec536c', '#f0f1f4']);
